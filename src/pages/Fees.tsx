...
const Fees = () => {
  return (
    ...
    <div className="flex flex-col md:mx-0 mx-[2rem]  md:items-center mt-[10rem] ">
                ...
                <button className='border border-secondary text-black z-10 rounded-lg mt-[5rem] hover:bg-secondary hover:text-white md:w-[881px] h-[79px] flex items-center justify-center'>Download our schedule of fees</button>
            </div>
