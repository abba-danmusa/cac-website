...
const AdditionalInfo = () => {
  return (
    <div className="flex flex-row md:justify-around space-y-16 px-8 py-8 relative">
      ...
      <div className="bg-primary flex flex-col space-y-4 z-10 w-96 h-72 p-3 md:p-4">
        <ul className="list-disc  md:pl-5 py-10 space-y-8 text-black">
          <li className="flex cursor-pointer text-[13px] justify-between items-center ">
          ...
          <li className="flex cursor-pointer text-[12px] justify-between items-center">
          <div className="h-4 w-4 rounded-full mr-4 bg-secondary"/>
