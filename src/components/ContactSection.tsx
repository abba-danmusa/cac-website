                    ...
                    <div className="col-sm-6 mb-xs-30 d-flex align-items-stretch">
                        <div className="alt-features-item border-left mt-0 wow fadeScaleIn" data-wow-delay=".3s">
                            ...
                            <div className="alt-features-descr clearlinks">
                                <div><a href="mailto:cservice@cac.gov.ng">cservice@cac.gov.ng</a></div>
            ...
            <div className="col-md-6 mb-sm-50">
                ...
                <form className="form contact-form pe-lg-5" id="contact_form">
                    ...
                    <div className="form-group">
                        ...
                        <textarea name="message" id="message" className="input-lg round form-control" style={{ height: 130 }} placeholder="Enter your message"></textarea>
                    </div>
