  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
      <div className="container mx-auto px-6 lg:px-12 flex justify-between items-center py-4">
        ...
        >
          <Link href="/" className={`nav-link ${location === "/" && "text-green-600 border-green-600"}`}>
            Home
          </Link>
          <Link href="/who" className={`nav-link ${location === "/who" && "text-green-600 border-green-600"}`}>
            About Us
          </Link>
          ...
          <Link href="/resources" className={`nav-link ${location === "/resources" && "text-green-600 border-green-600"}`}>
            Resources
          </Link>
          <a
